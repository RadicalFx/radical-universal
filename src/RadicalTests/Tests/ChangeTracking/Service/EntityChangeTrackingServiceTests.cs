namespace RadicalTests.ChangeTracking
{
    ...
    public class EntityChangeTrackingServiceTests
    {
        class FakeChange<T> : Change<T>
        {
            ...
            public bool? IsCommitSupportedTestValue;

            public override bool IsCommitSupported
            {
                get
                {
                    if(this.IsCommitSupportedTestValue.HasValue)
                    {
                        return this.IsCommitSupportedTestValue.Value;
                    }
                    return base.IsCommitSupported;
                }
            }

            public List<CommitReason> CommitsCalls = new List<CommitReason>();

            protected override void OnCommit(CommitReason reason)
            {
                this.CommitsCalls.Add(reason);

                base.OnCommit(reason);
            }
        }
        ...
        public void changeTrackingService_ctor_normal_hasTransientEntities_should_be_false()
        {
            ...
            Assert.IsFalse(svc.HasTransientEntities);
        }
        ...
        public void changeTrackingService_hasTransientEntities_should_be_true_with_transient_entities()
        {
            ...
            Assert.IsTrue(svc.HasTransientEntities);
        }
        ...
        public void service_add_notSupported_AddChangeBehavior()
        {
            ...
            {
                IChange stub = new FakeChange<String>(this, "foo", v => { }, v => { });
        ...
        public void service_generate_valid_advisory()
        {
            ...
            Assert.AreEqual(1, advisory.Count());
            Assert.AreEqual(ProposedActions.Create, advisory.First().Action);
        }
        ...
        public void service_should_generate_advisory_with_update_action()
        {
            ...
            Assert.AreEqual(ProposedActions.Update, advisory.First().Action);
        }
        ...
        class MockIAdvisoryBuilder : IAdvisoryBuilder
        {
            public Func<IChangeTrackingService, IChangeSet, IAdvisory> GenerateAdvisoryFunc;

            public IAdvisory GenerateAdvisory(IChangeTrackingService svc, IChangeSet changeSet)
            {
                return this.GenerateAdvisoryFunc(svc, changeSet);
            }
        }
        ...
        public void service_generate_valid_adivsory_with_valid_iAdvisoryBuilder()
        {
            ...
            var mock = new MockIAdvisoryBuilder()
            {
                GenerateAdvisoryFunc = (s, cs) => 
                {
                    actual++;
        ...
        public void service_getChangeSet_when_is_not_changed_empty_cSet()
        {
            ...
            Assert.AreEqual(0, cSet.Count);
        }

        [TestMethod]
        [TestCategory("ChangeTracking")]
        public void service_getChangeSet_with_null_iChangeSetFilter_should_throw_ArgumentNullException()
        {
            Assert.ThrowsException<ArgumentNullException>(() =>
            {
                ChangeTrackingService svc = new ChangeTrackingService();
        ...
        class MockIChangeSetFilter : IChangeSetFilter
        {
            public Predicate<IChange> ShouldIncludePredicate = c => true;

            public bool ShouldInclude(IChange change)
            {
                return this.ShouldIncludePredicate(change);
            }
        }
        ...
        public void service_getChangeSet_with_valid_iChangeSetFilter()
        {
            ...
            var expectedFilterCalls = 2;
            var actualFilterCalls = 0;
            ...
            var cSet = svc.GetChangeSet(new MockIChangeSetFilter()
            {
                ShouldIncludePredicate = c =>
                {
                    actualFilterCalls++;
                    return true;
                }
            ...
            Assert.AreEqual(expectedFilterCalls, actualFilterCalls);
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var iChange = new FakeChange<String>(this, "foo", v => { }, v => { });
            iChange.IsCommitSupportedTestValue = true;
            ...
            Assert.AreEqual(1, iChange.CommitsCalls.Count);
            Assert.AreEqual(CommitReason.AcceptChanges, iChange.CommitsCalls.Single());
        }
        ...
        {
            var iChange = new PropertyValueChange<string>(this, "property-name", "foo", e => { }, e => { }, "");
        ...
        public void service_on_change_commit_EnumValueOutOfRangeException_on_invalid_commit_reason_with_hacked_property_change()
        {
            Assert.ThrowsException<EnumValueOutOfRangeException>(() =>
            {
                var iChange = new HackedPropertyValueChange(this, "Foo", e => { }, e => { });
        ...
        public void service_on_dispose_raise_disposed_event()
        {
            ...
            {
                actual++;
                ((ChangeTrackingService)s).Disposed -= h;
            };
        ...
        public void changeTrackingService_createBookmark_normal_should_create_a_bookmark_with_entities_transient_before_bookmark_creation()
        {
            ...
            Assert.IsTrue(target.TransientEntities.Contains(person));
        }
